...
export default function CarInteriorsCarousel({ page = 'homepage' }) {
  ...
  const handleSave = async () => {
    ...
    try {
      const slideData = {
        ...formData,
        componentName: 'car-interiors-carousel',
      ...
      if (editingSlide) {
        ...
        toast.success('Car interior slide updated successfully');
      } else {
        await axios.post('/api/admin/display-assets', slideData);
        toast.success('Car interior slide created successfully');
      }
  ...
  const handleDelete = async (slideId) => {
    ...
    try {
      ...
      toast.success('Car interior slide deleted successfully');
      fetchSlides();
    } catch (error) {
    ...
    return (
      <Box sx={{ 
        ...
        <Typography variant="h6" sx={{ color: '#f0f6fc', fontWeight: 600 }}>
          Loading car interiors carousel...
        </Typography>
    ...
    <Box sx={{ 
      ...
      <Box sx={{ 
        ...
        <Box>
          <Typography variant="h4" sx={{ 
            ...
            Car Interiors Carousel
          </Typography>
          <Typography variant="body2" sx={{ color: '#7d8590' }}>
            Manage car interior slides for your homepage
          </Typography>
        </Box>
        <Button
          variant="contained"
      ...
      {slides.length === 0 ? (
        <Card sx={{ 
          ...
          <ViewCarousel sx={{ fontSize: 64, color: '#f85149', mb: 3 }} />
          <Typography variant="h5" sx={{ color: '#f0f6fc', mb: 2, fontWeight: 600 }}>
            No car interior slides found
          </Typography>
          <Typography variant="body1" sx={{ color: '#7d8590', mb: 4, maxWidth: 400, mx: 'auto' }}>
            Create car interior slides to showcase your automotive interior services
          </Typography>
          <Button 
            variant="contained" 
            startIcon={<Add />} 
      ...
      >
        <DialogTitle sx={{ 
          ...
          {editingSlide ? 'Edit Car Interior Slide' : 'Create Car Interior Slide'}
        </DialogTitle>
        <DialogContent>
